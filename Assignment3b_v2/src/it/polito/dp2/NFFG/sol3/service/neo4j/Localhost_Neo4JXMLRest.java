...
}, comments = "wadl2java, http://wadl.java.net", date = "2017-01-24T23:40:28.653+01:00")
public class Localhost_Neo4JXMLRest {
    ...
    public static class Resource {
        ...
        public static class Node {
            ...
            public it.polito.dp2.NFFG.sol3.service.neo4j.Node postXmlAsNode(it.polito.dp2.NFFG.sol3.service.neo4j.Node input) {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
                ...
                return response.getEntity(it.polito.dp2.NFFG.sol3.service.neo4j.Node.class);
            }
        ...
        public static class NodeNodeid {
            ...
            public it.polito.dp2.NFFG.sol3.service.neo4j.Node getAsNode() {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
        ...
        public static class NodeNodeidRelationship {
            ...
            public it.polito.dp2.NFFG.sol3.service.neo4j.Relationship postXmlAsRelationship(it.polito.dp2.NFFG.sol3.service.neo4j.Relationship input) {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
                ...
                return response.getEntity(it.polito.dp2.NFFG.sol3.service.neo4j.Relationship.class);
            }
        ...
        public static class Nodes {
            ...
            public it.polito.dp2.NFFG.sol3.service.neo4j.Nodes getAsNodes() {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
                ...
                return response.getEntity(it.polito.dp2.NFFG.sol3.service.neo4j.Nodes.class);
            }
        ...
        public static class RelationshipRelationshipid {
            ...
            public it.polito.dp2.NFFG.sol3.service.neo4j.Relationship getAsRelationship() {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
