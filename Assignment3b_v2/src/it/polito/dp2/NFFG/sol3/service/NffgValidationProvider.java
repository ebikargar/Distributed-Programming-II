...
//against the schema
//we can put the class inside the service package
...
public class NffgValidationProvider implements MessageBodyReader<JAXBElement<?>> {
	...
	public NffgValidationProvider() {
		...
		try {
			...
			InputStream templateStream = NffgValidationProvider.class
