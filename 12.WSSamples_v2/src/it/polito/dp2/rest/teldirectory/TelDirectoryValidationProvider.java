...
public class TelDirectoryValidationProvider implements MessageBodyReader<JAXBElement<?>> {
	final String jaxbPackage = "it.polito.dp2.rest.teldirectory.jaxb";
	Unmarshaller unmarshaller;
	Logger logger;
	String responseBodyTemplate;


	public TelDirectoryValidationProvider() {
		logger = Logger.getLogger(TelDirectoryValidationProvider.class.getName());

		try {				
			InputStream schemaStream = TelDirectoryValidationProvider.class.getResourceAsStream("/xsd/Teldirectory.xsd");
			...
			InputStream templateStream = TelDirectoryValidationProvider.class.getResourceAsStream("/html/BadRequestBodyTemplate.html");
