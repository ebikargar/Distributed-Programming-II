 ...
 *       &lt;sequence>
 *         &lt;element name="funcType" type="{http://www.example.org/nffgInfo}funcType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ProviderCatType {
    ...
    protected List<FuncType> funcType;
     ...
     * 
     */
    public List<FuncType> getFuncType() {
        if (funcType == null) {
            funcType = new ArrayList<FuncType>();
        }
